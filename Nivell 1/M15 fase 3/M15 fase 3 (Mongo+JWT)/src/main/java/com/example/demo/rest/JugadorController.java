...
import com.example.demo.models.Tirada;
...
public class JugadorController {
	...
	public ResponseEntity<Jugador> update(@PathVariable String id, @Valid @RequestBody Jugador jugadorModificat) {
		/*
	...
	public ResponseEntity<Tirada> create(@RequestBody @Valid Tirada tirada, @PathVariable String jugadorId) {
	...
	public ResponseEntity<Jugador> eliminarTirades(@PathVariable String id) {
		Optional<Jugador> optionalJugador = jugadorRepository.findById(id);
		if (!optionalJugador.isPresent()) {
			return ResponseEntity.unprocessableEntity().build();
		}
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Jugador> delete(@PathVariable String id) {
		Optional<Jugador> optionalJugador = jugadorRepository.findById(id);
		if (!optionalJugador.isPresent()) {
			return ResponseEntity.unprocessableEntity().build();
		}
	...
	public ResponseEntity<Page<Tirada>> getencertssByJugadorId(@PathVariable String jugadorId, Pageable pageable) {
